...
const en = {
  ...
  home: {
    ...
    badgeRefineryDesc: 'Earned by fulfilling refinery orders on Parasite Pool. {{count}} fulfilled.',
    blockBadgeTitle: 'Block {{height}}',
    badgeBlockWinnerTitle: 'Block {{height}} — Winner',
    badgeBlockStackTitle: 'More Blocks',
    badgeBlockStackDesc: '{{count}} more blocks mined.',
    badgeLoyaltyTitle: 'Loyalty',
    badgeLoyaltyDesc: 'Loyal miner — {{blocks}}k blocks mined with the pool.',
    badgeAuctionTitle: 'Auction Winner',
    badgeAuctionDesc: '{{count}} auctions won on Parabid.',
    badgeBravocadoTitle: 'Bravocado',
    badgeBravocadoDesc: 'Collected from the dispenser.',
    badgeMinerTitle: 'Miner',
    badgeMinerDesc: 'Collected from the dispenser.',
    badgeDispenserTitle: 'Dispenser Collector',
    badgeDispenserDesc: '{{count}} dispenser asset types collected.',
    badgeRank: 'Rank',
    ...
    miningRewardAtAuction: 'At auction',
    auctionCurrentBid: '{{sats}} sats',
    auctionNoBids: 'no bids · {{sats}} sats',
    auctionBid: 'Bid on Parabid',
