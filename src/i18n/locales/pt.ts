...
const pt = {
  ...
  home: {
    ...
    badgeRefineryDesc: 'Obtido ao concluir pedidos de refinaria na Parasite Pool. {{count}} concluídos.',
    badgeBlockWinnerTitle: 'Bloco {{height}} — Vencedor',
    badgeBlockStackTitle: 'Mais blocos',
    badgeBlockStackDesc: '{{count}} blocos a mais minerados.',
    badgeLoyaltyTitle: 'Lealdade',
    badgeLoyaltyDesc: 'Minerador leal — {{blocks}}k blocos minerados com a pool.',
    badgeAuctionTitle: 'Vencedor de leilão',
    badgeAuctionDesc: '{{count}} leilões vencidos no Parabid.',
    badgeBravocadoTitle: 'Bravocado',
    badgeBravocadoDesc: 'Coletado do dispensador.',
    badgeMinerTitle: 'Minerador',
    badgeMinerDesc: 'Coletado do dispensador.',
    badgeDispenserTitle: 'Colecionador do dispensador',
    badgeDispenserDesc: '{{count}} tipos de ativos do dispensador coletados.',
    ...
    badgeWorkShare: 'Seu trabalho: {{share}} do bloco',
    ...
    miningRewardAtAuction: 'Em leilão',
    auctionCurrentBid: '{{sats}} sats',
    auctionNoBids: 'sem lances · {{sats}} sats',
    auctionBid: 'Dar lance no Parabid',
  ...
  miners: {
    ...
    autotune: 'Autoajuste',
    autotuneHint: 'Ajustar frequência e voltagem automaticamente',
  ...
  errors: {
    ...
    failedToAutotune: 'Falha ao iniciar o autoajuste',
