...
const fr = {
  ...
  home: {
    ...
    badgeRefineryDesc: 'Obtenu en honorant des commandes de raffinerie sur Parasite Pool. {{count}} honorées.',
    badgeBlockWinnerTitle: 'Bloc {{height}} — Gagnant',
    badgeBlockStackTitle: 'Autres blocs',
    badgeBlockStackDesc: '{{count}} blocs supplémentaires minés.',
    badgeLoyaltyTitle: 'Fidélité',
    badgeLoyaltyDesc: 'Mineur fidèle — {{blocks}}k blocs minés avec le pool.',
    badgeAuctionTitle: 'Gagnant aux enchères',
    badgeAuctionDesc: '{{count}} enchères remportées sur Parabid.',
    badgeBravocadoTitle: 'Bravocado',
    badgeBravocadoDesc: 'Obtenu au distributeur.',
    badgeMinerTitle: 'Mineur',
    badgeMinerDesc: 'Obtenu au distributeur.',
    badgeDispenserTitle: 'Collectionneur du distributeur',
    badgeDispenserDesc: '{{count}} types d\'actifs du distributeur collectionnés.',
    blockBadgeTitle: 'Bloc {{height}}',
    badgeRank: 'Rang',
    badgeParticipants: 'Participants',
    badgeTopDiff: 'Difficulté max',
    badgeWinnerDiff: 'Diff gagnante',
    badgeWorkShare: 'Votre travail : {{share}} du bloc',
    badgeWon: 'Bloc gagné',
    ...
    miningRewardAtAuction: 'Aux enchères',
    auctionCurrentBid: '{{sats}} sats',
    auctionNoBids: 'aucune offre · {{sats}} sats',
    auctionBid: 'Enchérir sur Parabid',
    ...
    rewardsLeft: '{{remaining}}/{{total}} restants',
  ...
  miners: {
    ...
    autotune: 'Auto-réglage',
    autotuneHint: 'Régler automatiquement la fréquence et la tension',
    autotuneRunning: 'Auto-réglage en cours...',
    autotuneStarted: 'Auto-réglage démarré',
    settings: 'Paramètres',
    remove: 'Supprimer',
    online: 'En ligne',
    offline: 'Hors ligne',
  ...
  errors: {
    ...
    failedToAutotune: "Échec du démarrage de l'auto-réglage",
