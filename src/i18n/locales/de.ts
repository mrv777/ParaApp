...
const de = {
  ...
  home: {
    ...
    hashrate: 'Hashrate',
    bestDiff: 'Beste Diff.',
    hashrateAndBestDiff: 'Hashrate & Beste Diff.',
    bestDiffShortRangeNote: 'Best-Diff-Markierungen sind in den Ansichten 1h und 24h verfügbar.',
    tapDifficultyTimeline: 'Zum Prüfen auf die Zeitleiste tippen',
    blockNumber: 'Block #{{height}}',
    bestDiffHitAccessibility: 'Beste Diff. {{diff}}, Block {{block}}, {{time}}',
    fleet: 'Miner-Flotte',
    swarm: 'Schwarm',
    ...
    badgeRefineryDesc: 'Erhalten durch Erfüllen von Raffinerie-Bestellungen im Parasite Pool. {{count}} erfüllt.',
    badgeBlockWinnerTitle: 'Block {{height}} — Gewinner',
    badgeBlockStackTitle: 'Weitere Blöcke',
    badgeBlockStackDesc: '{{count}} weitere Blöcke geschürft.',
    badgeLoyaltyTitle: 'Treue',
    badgeLoyaltyDesc: 'Treuer Miner — {{blocks}}k Blöcke mit dem Pool geschürft.',
    badgeAuctionTitle: 'Auktionsgewinner',
    badgeAuctionDesc: '{{count}} Auktionen auf Parabid gewonnen.',
    badgeBravocadoTitle: 'Bravocado',
    badgeBravocadoDesc: 'Aus dem Dispenser gesammelt.',
    badgeMinerTitle: 'Miner',
    badgeMinerDesc: 'Aus dem Dispenser gesammelt.',
    badgeDispenserTitle: 'Dispenser-Sammler',
    badgeDispenserDesc: '{{count}} Dispenser-Asset-Typen gesammelt.',
    blockBadgeTitle: 'Block {{height}}',
    badgeRank: 'Rang',
    badgeParticipants: 'Teilnehmer',
    badgeTopDiff: 'Höchste Schwierigkeit',
    badgeWinnerDiff: 'Gewinner-Diff',
    badgeWorkShare: 'Deine Arbeit: {{share}} des Blocks',
    ...
    miningRewardCode: 'Einlösecode',
    miningRewardHint: 'Reiche Shares mit hoher Schwierigkeit ein, um Belohnungen zu verdienen.',
    miningRewardTierTarget: 'Ziel {{diff}}',
    miningRewardAtAuction: 'Wird versteigert',
    auctionCurrentBid: '{{sats}} Sats',
    auctionNoBids: 'keine Gebote · {{sats}} Sats',
    auctionBid: 'Auf Parabid bieten',
    rewardsView: 'Belohnungen ansehen',
    rewardsCatalogTitle: 'Verfügbare Belohnungen',
    rewardsCatalogIntro: 'Belohnungen und die minimale Share-Schwierigkeit, um sie zu verdienen.',
    rewardsCatalogEmpty: 'Noch keine Belohnungen verfügbar.',
    rewardsLeft: '{{remaining}}/{{total}} übrig',
    rewardsNextTarget: 'Nächstes Ziel',
    rewardsYourBest: 'Deine Beste: {{diff}}',
    refinery: 'Refinery',
    refineryOrder: 'Auftrag #{{id}}',
    refineryStatus: 'Status',
    refineryReview: 'Prüfung',
    refineryStatusPending: 'Ausstehend',
    refineryStatusInMempool: 'Im Mempool',
    refineryStatusActive: 'Aktiv',
    refineryStatusFulfilled: 'Erfüllt',
    refineryStatusCancelled: 'Storniert',
    refineryStatusDisconnected: 'Getrennt',
    refineryStatusExpired: 'Abgelaufen',
    refineryFlagged: 'Markiert',
    refineryCleared: 'Freigegeben',
    refineryProgress: 'Fortschritt',
    refineryUnlimited: 'Unbegrenzt',
    refineryBestShare: 'Beste',
    refineryHashrate: 'Hashrate',
    refineryCreated: 'Erstellt',
    refineryBlockHeight: 'Blockhöhe',
    refineryTxids: 'Transaktionen',
  },
  ...
  miners: {
    ...
    autotuneHint: 'Frequenz & Spannung automatisch abstimmen',
    autotuneRunning: 'Auto-Tuning läuft...',
    autotuneStarted: 'Auto-Tuning gestartet',
    settings: 'Einstellungen',
    remove: 'Entfernen',
    online: 'Online',
    offline: 'Offline',
  ...
  errors: {
    ...
    failedToAutotune: 'Auto-Tuning konnte nicht gestartet werden',
